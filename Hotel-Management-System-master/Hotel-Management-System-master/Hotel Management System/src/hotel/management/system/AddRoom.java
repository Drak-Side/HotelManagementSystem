        ...
        public void actionPerformed(ActionEvent ae) {
                try {
                        if (ae.getSource() == b1) {
                                ...
                                try {
                                        conn c = new conn();
                                        String str = "INSERT INTO room (room, available, status, price, type) VALUES ('"
                                                        + room + "', '" + available + "', '" + status + "', '" + price
                                                        + "', '" + type + "')";
                                        ...
                                        ee.printStackTrace();
                                        JOptionPane.showMessageDialog(null, "Error while adding room.");
                                }
