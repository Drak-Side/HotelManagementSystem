...
public class UpdateCheck extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==check){
			...
			// String updateString="select * from customer where s2='"+number+"'";
            try{
                conn c=new conn();
				// String id=ccoustomer.getSelectedItem();
			
                c.s.executeUpdate("update this customer set s6 ='"+room+"', s3 ='"+name+"', s7='"+chickIn+"', s8='"+deposit+"',where s1='"+number+"'");
