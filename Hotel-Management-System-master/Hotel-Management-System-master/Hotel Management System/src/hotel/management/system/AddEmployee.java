        ...
        Next.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                if (name.isEmpty() || age.isEmpty() || salary.isEmpty() || phone.isEmpty() || aadhar.isEmpty()
                        || email.isEmpty() || gender == null || job == null) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Age and Salary must be numeric values.");
                    return;
                }

                // Validate Phone and Aadhar
                if (!phone.matches("\\d{10}")) { // Validate phone number to be exactly 10 digits
                    JOptionPane.showMessageDialog(null, "Phone number must be 10 digits.");
                    return;
                }

                if (!aadhar.matches("\\d{12}")) { // Validate Aadhar to be exactly 12 digits
                ...
                try {
                    conn c = new conn();
                    String str = "INSERT INTO employe VALUES ('" + name + "', '" + age + "', '" + gender + "', '" + job
